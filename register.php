        ...
        <table id="reg_table">
            ...
            <tr class="reg_tr1">
                ...
                <td class="reg_input_td">
                    <input type="text" class="reg_input" id="reg_user_name_input" name="reg_user_name_input">
                </td>
            </tr>
            <tr class="reg_tr2">
                <td class="reg_label_td">
                ...
                <td class="reg_input_td">
                    <input type="text" class="reg_input" id="reg_user_passwd_input" name="reg_user_passwd_input">
                </td>
            </tr>
            <tr class="reg_tr1">
                <td class="reg_label_td">
                ...
                <td class="reg_input_td">
                    <input type="text" class="reg_input" id="reg_user_email_input" name="reg_user_email_input">
                </td>
            </tr>
            <tr class="reg_tr2">
